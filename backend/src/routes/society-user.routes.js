...
router.post('/society-admin', authorizePermissions('society.users.create'), enforceSubscriptionLimit('users'), validateCreateSocietyAdmin, handleValidationErrors, createSocietyAdmin);
